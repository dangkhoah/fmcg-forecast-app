...
import { Download, TrendingUp, Filter, Loader2, Search, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, RotateCcw, Save, Eye, X } from 'lucide-react';
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: '13px', color: '#4338ca', fontWeight: 500 }}>
                  Viewing historical forecast from {new Date(result.created_at).toLocaleString()}
                </span>
              </div>
              <button
              ...
              {history.map((h) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ fontWeight: isActive ? 600 : 400, color: isActive ? '#4338ca' : undefined }}>
